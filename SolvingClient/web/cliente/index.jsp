    ...
    <body>        
        <ul class="nav nav-tabs" role="tablist">
            ...
            <div style="float: right; vertical-align: middle; margin-right: 10px; margin-top: 5px; margin-bottom: 5px;">
                ...
                <button name="btnSalir" class="btn-sm btn-danger" onclick="location='<% out.print(request.getContextPath()); %>'" >
                    <span class="glyphicon glyphicon-log-out"></span>&nbsp;&nbsp; Cerrar Session
                </button>
            </div>
        </ul>
